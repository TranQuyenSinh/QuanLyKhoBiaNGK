...
namespace QuanLyKhoBiaNGK.Controllers
{
    public class SuppliersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FullName,Address,Phone,Email")] Supplier supplier)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FullName,Address,Phone,Email")] Supplier supplier)
        {
            if (id != supplier.Id)
            {
                return NotFound();
